<aside class="sidenav navbar navbar-vertical navbar-expand-xs my-3 fixed-start ms-3 bg-transparent" id="sidenav-main">
    ...
    <div class="collapse navbar-collapse w-auto h-auto" id="sidenav-collapse-main">
        ...
        <ul class="navbar-nav" style="padding-bottom: 50px;">
            ...
            @if(auth()->user()->hasAkses('dashboard'))
            <li class="nav-item">
            ...
            @if(auth()->user()->hasAkses('identifikasi_risiko'))
            <li class="nav-item">
            ...
            @if(auth()->user()->hasAkses('analisis_risiko'))
            <li class="nav-item">
            ...
            @if(auth()->user()->hasAkses('analisis_kecukupan'))
            <li class="nav-item">
            ...
            @if(auth()->user()->hasAkses('evaluasi_risiko'))
            <li class="nav-item">
            ...
            @if(auth()->user()->hasAkses('daftar_risiko'))
            <li class="nav-item">
            ...
            @if(auth()->user()->hasAkses('kategori_risiko') || auth()->user()->hasAkses('ruang_lingkup') || auth()->user()->hasAkses('probabilitas') || auth()->user()->hasAkses('dampak'))
            <li class="nav-item mt-3">
                <h6 class="ps-4 ms-2 text-uppercase text-xs font-weight-bolder opacity-6 nav-category-text">MASTER DATA</h6>
            </li>
            @endif

            @if(auth()->user()->hasAkses('kategori_risiko'))
            <li class="nav-item">
            ...
            @if(auth()->user()->hasAkses('ruang_lingkup'))
            <li class="nav-item">
            ...
            @if(auth()->user()->hasAkses('probabilitas'))
            <li class="nav-item">
            ...
            @if(auth()->user()->hasAkses('hak_akses') || auth()->user()->hasAkses('users') || auth()->user()->hasAkses('roles') || auth()->user()->hasAkses('units'))
            <li class="nav-item mt-3">
                <h6 class="ps-4 ms-2 text-uppercase text-xs font-weight-bolder opacity-6 nav-category-text">PENGATURAN</h6>
            </li>
            @endif

            @if(auth()->user()->hasAkses('hak_akses'))
            <li class="nav-item">
                <a class="nav-link {{ request()->is('master/hak-akses*') ? 'active' : '' }}" href="{{ route('hak-akses.index') }}" data-mini-title="Hak Akses">
                    <div class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
            ...
            @if(auth()->user()->hasAkses('users'))
            <li class="nav-item">
                <a class="nav-link {{ request()->is('master/users*') ? 'active' : '' }}" href="{{ route('users.index') }}" data-mini-title="Users">
                    <div class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
            ...
            @if(auth()->user()->hasAkses('roles'))
            <li class="nav-item">
                <a class="nav-link {{ request()->is('master/roles*') ? 'active' : '' }}" href="{{ route('roles.index') }}" data-mini-title="Roles">
                    <div class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
            ...
            @if(auth()->user()->hasAkses('units'))
            <li class="nav-item">
                <a class="nav-link {{ request()->is('master/units*') ? 'active' : '' }}" href="{{ route('units.index') }}" data-mini-title="Units">
                    <div class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
