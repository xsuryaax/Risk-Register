...
class IdentifikasiRisikoSeeder extends Seeder
{
    ...
    public function run(): void
    {
        ...
        $risks = [
            ...
            [
                'unit_id' => $unit->id,
                'kegiatan' => 'Backup database server tidak berjalan maksimal',
                'tujuan_kegiatan' => 'Menjamin ketersediaan data cadangan saat terjadi bencana data',
                'kode_risiko' => 'B-2026-009',
                'kategori_risiko_id' => $kategoriOperasional->id ?? 1,
                'ruang_lingkup_id' => $lingkupBisnis->id ?? 1,
                'pernyataan_risiko' => 'Kegagalan backup server database berpotensi kehilangan data transaksi medis',
                'sebab' => 'Kapasitas storage penuh atau scheduler error',
                'jenis_risiko' => 'C',
                'dampak' => 'Kehilangan rekam medis elektronik pasien',
                'user_id' => $user->id,
            ],
            [
                'unit_id' => $unit->id,
                'kegiatan' => 'Penggunaan software bajakan di beberapa unit kerja',
                'tujuan_kegiatan' => 'Menghindari tuntutan hukum dan serangan malware',
                'kode_risiko' => 'B-2026-010',
                'kategori_risiko_id' => $kategoriLegal->id ?? 1,
                'ruang_lingkup_id' => $lingkupBisnis->id ?? 1,
                'pernyataan_risiko' => 'Penggunaan software unlicensed meningkatkan resiko backdoor dan audit compliance',
                'sebab' => 'Keterbatasan anggaran lisensi tahunan',
                'jenis_risiko' => 'UC',
                'dampak' => 'Tuntutan pelanggaran HAKI dan denda finansial',
                'user_id' => $user->id,
            ],
            [
                'unit_id' => $unit->id,
                'kegiatan' => 'Akses fisik ruang server tidak terkontrol dengan ketat',
                'tujuan_kegiatan' => 'Melindungi aset hardware dan data sensitif secara fisik',
                'kode_risiko' => 'F-2026-002',
                'kategori_risiko_id' => $kategoriOperasional->id ?? 1,
                'ruang_lingkup_id' => $lingkupFasilitas->id ?? 1,
                'pernyataan_risiko' => 'Akses orang yang tidak berkepentingan ke ruang server berpotensi sabotase hardware',
                'sebab' => 'Sistem absensi/logbook ruang server belum elektronik',
                'jenis_risiko' => 'C',
                'dampak' => 'Kerusakan fisik aset IT dan pencurian storage',
                'user_id' => $user->id,
            ],
        ];
